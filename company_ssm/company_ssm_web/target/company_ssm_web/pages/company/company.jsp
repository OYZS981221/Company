                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-pad">
                                <div class="property-thumbnail">
                                    <a href="${pageContext.request.contextPath}/Company/companyA.do?id=${item.id}" class="property-img">
                            ...
                            <div class="col-lg-7 col-md-7 col-pad align-self-center">
                                <div class="detail">
                                    <h3 class="title">
                                        <a href="${pageContext.request.contextPath}/Company/companyA.do?id=${item.id}">${item.name}</a>
                                    </h3>
                                    <h5 class="location">
