...
<div class="page-container">
        ...
        <div class="text-c">
            <form action="${pageContext.request.contextPath}/Comment/selectFuzzyU.do" method="post">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="40">ID</th>
                <th width="220">评论内容</th>
                <th width="160">评论企业</th>
                <th width="120">经营类型</th>
    ...
    function del() {
        ...
        if (Checkbox) {//boolean值为true
            ...
            if (r == true) {
                ...
                $.get("${pageContext.request.contextPath}/Comment/deleteByIds.do", ids, function (data) {
                    if (data == "ok") {
