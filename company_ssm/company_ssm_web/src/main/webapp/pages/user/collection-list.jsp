...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户收藏 <span
        class="c-gray en">&gt;</span> 收藏列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i
        class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">

    <div class="text-c">
        <form action="${pageContext.request.contextPath}/Collection/selectFuzzy.do">
...
<script type="text/javascript">
    ...
    function company_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/Collection/deleteCollection.do',
                dataType: 'json',
    ...
    function del() {
        ...
        if (Checkbox) {//boolean值为true
            ...
            if (r == true) {
                ...
                $.get("${pageContext.request.contextPath}/Collection/deleteByIds.do", ids, function (data) {
                    if (data == "ok") {
