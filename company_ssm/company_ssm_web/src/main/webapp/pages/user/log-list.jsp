...
<div class="page-container">
    ...
    <div class="text-c">
        ...
        <input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'endTime\')||\'%y-%M-%d\'}' })" id="beginTime"
               name="beginTime" class="input-text Wdate" style="width:140px;">
        <input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'beginTime\')}',maxDate:'%y-%M-%d' })"
               id="endTime" name="endTime" class="input-text Wdate" style="width:140px;">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="230">ID</th>
                <th width="252">登录IP</th>
                <th width="252">登录时间</th>
<%--                <th width="252">登录地点</th>--%>
                <th width="220">操作</th>
            </tr>
            </thead>
            <tbody>
...
<script type="text/javascript">
    ...
    function company_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/Log/deleteLog.do',
                dataType: 'json',
    ...
    function del() {
        ...
        if (Checkbox) {//boolean值为true
            ...
            if (r == true) {
                ...
                $.get("${pageContext.request.contextPath}/Log/deleteByIds.do", ids, function (data) {
                    if (data == "ok") {
