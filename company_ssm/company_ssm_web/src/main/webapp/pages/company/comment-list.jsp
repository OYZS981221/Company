...
<div class="page-container">
    <form action="${pageContext.request.contextPath}/Comment/selectFuzzy.do" method="post">
    <div class="text-c">
        日期范围：
        ...
        评论用户：<input type="text" name="userName" id="user" placeholder=" 用户" style="width:200px" class="input-text">
        评论企业：<input type="text" name="companyName" id="boss" placeholder=" 企业" style="width:200px" class="input-text">
        <input type="text" name="keyWords" id="keyWords" placeholder="关键字" style="width:200px" class="input-text">
        <button class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜评论</button>
    </div>
    </form>
